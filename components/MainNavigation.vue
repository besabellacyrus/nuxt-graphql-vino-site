<template>
  <div>
    ...
    <div v-show="isOpen" class="w-full bg-white side-bar">
      <div class="relative mt-32">
        <div class="text-center flex flex-col">
          <a class="mb-6 font-semibold text-lg" href="/">Home</a>
          <a class="mb-6 font-semibold text-lg" href="/about">About</a>
          <a class="mb-6 font-semibold text-lg" href="/pairing">Pairing</a>
          <a class="mb-6 font-semibold text-lg" href="/visit">Visit</a>
          <a class="mb-6 font-semibold text-lg" href="/shop">Shop</a>
          <a class="mb-6 font-semibold text-lg" href="/events">Events</a>
          <a class="mb-6 font-semibold text-lg" href="/contact">Contact</a>
        </div>
      </div>
    </div>
  </div>
